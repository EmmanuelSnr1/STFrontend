    ...
    <header className="fixed w-full z-50 h-24 text-gray-600 body-font bg-black/80 drop-shadow-lg">
      <div className="container flex justify-between flex-row flex-wrap items-center p-5 mx-auto">
        <Link to="/" className="flex items-center">
          ...
          <div className="text-2xl lg:text-[32px] text-accent font-bold">
            StocXTune
          </div>
        </Link>

        <nav className="hidden lg:block flex space-x-6 flex-wrap  items-center justify-center text-base md:mr-auto md:ml-4 md:py-1 md:pl-4">
          ...
          <SiteLink path="/guide" display="New To Investing?" />
        </nav>
        ...
        <div className="flex">
          {user ? (
            ...
            <>
              <Link to="/register">
                <button className="mr-2 text-white btn bg-primary border-primary hidden lg:block">
                  Register
                </button>
              </Link>
              <Link to="/login">
          ...
          <div className="dropdown dropdown-end lg:hidden">
            <label
              tabIndex="0"
              className="btn btn-circle btn-ghost btn-secondary ml-6"
            >
          ...
          <div className="dropdown dropdown-end lg:hidden">
            <label
              tabIndex="0"
              className="btn btn-circle btn-secondary btn-secondary ml-6"
            >
              <FaBars />
            </label>
            <ul
            ...
            >
              ...
              <li>
                <Link to="/my-portfolio" className="">
                  My Portfolio
                </Link>
              </li>
              <li>
